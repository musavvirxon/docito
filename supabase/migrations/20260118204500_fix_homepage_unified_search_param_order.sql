-- File: supabase/migrations/20260118204500_fix_homepage_unified_search_param_order.sql
-- Fix: PostgREST schema cache expects homepage_unified_search(search_location, search_query)
-- This migration redefines the function with that parameter order (idempotent).
