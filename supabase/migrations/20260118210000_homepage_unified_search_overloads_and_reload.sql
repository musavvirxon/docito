-- File: supabase/migrations/20260118210000_homepage_unified_search_overloads_and_reload.sql


begin;

-- --------------------------------------------------------------------------------
-- Primary signature: (search_location, search_query)
-- --------------------------------------------------------------------------------
create or replace function public.homepage_unified_search(search_location text, search_query text)
returns jsonb
language plpgsql
stable
security definer
...
-- --------------------------------------------------------------------------------
-- Defensive overload: (search_query, search_location)
-- --------------------------------------------------------------------------------
...
set search_path = public
as $$
  select public.homepage_unified_search(search_location, search_query);
$$;
