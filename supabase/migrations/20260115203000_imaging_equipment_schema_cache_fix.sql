-- File: supabase/migrations/20260115203000_imaging_equipment_schema_cache_fix.sql
begin;

create extension if not exists pgcrypto;

-- -------------------------------------------------------------------
-- imaging_equipment (fixes "Could not find the table ... schema cache")
-- -------------------------------------------------------------------
...
-- -------------------------------------------------------------------
-- imaging_center_settings (used by embedded dashboard Settings section)
-- -------------------------------------------------------------------
...
-- Force PostgREST schema reload so REST/Edge Functions stop seeing stale schema cache
