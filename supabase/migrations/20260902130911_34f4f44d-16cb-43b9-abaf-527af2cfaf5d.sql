ALTER TABLE public.clinic_rooms ADD COLUMN IF NOT EXISTS show_on_display boolean NOT NULL DEFAULT false;
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'queue', COALESCE((
      ...
      JOIN public.clinic_rooms r3 ON r3.id = a.room_id AND r3.show_on_display = true
