-- File: supabase/migrations/20260115234500_pgrst_reload_and_imaging_tables.sql
begin;

create extension if not exists pgcrypto;

-- -------------------------------------------------------------------
-- Ensure tables exist in public schema (idempotent)
-- -------------------------------------------------------------------
...
-- -------------------------------------------------------------------
-- updated_at trigger helper (idempotent) + triggers
-- -------------------------------------------------------------------
do $$
begin
  if not exists (
...
-- -------------------------------------------------------------------
-- Force PostgREST schema cache reload (immediate)
-- -------------------------------------------------------------------
