...
/**
 * ✅ COMPAT EXPORT (Fix for crash)
 * Some files import { getUserRoles } from "@/lib/rbac"
 * Keep that working by exporting getUserRoles as an alias.
 */
export const getUserRoles = fetchUserRoles;

/**
 * If profile.roles is present in AuthContext, you can use this synchronously.
 */
