...
export default function PharmacyLandingPage() {
  ...
  const features = [
    ...
    { icon: RefreshCw, title: "Medication Refill Management", description: "Automated refill requests and smart patient reminders to boost adherence." },
    { icon: Package, title: "Inventory & Stock Control", description: "Real-time stock levels, expiry alerts, and supplier insights in one view." },
    { icon: Truck, title: "Online Orders & Delivery", description: "Enable home delivery with real-time order tracking for patients." },
    { icon: CreditCard, title: "Payments & Insurance", description: "Accept cash, cards, digital wallets, and process insurance claims seamlessly." },
    { icon: Users, title: "Patient Profiles", description: "Access medication history, allergies, and adherence tracking at a glance." },
    { icon: BarChart3, title: "Analytics Dashboard", description: "Sales trends, fast-moving drugs, and revenue insights to grow your business." },
  ];
        ...
        <section ref={heroRef} className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-20 relative h-48"
            >
              <motion.div
                animate={{ y: [0, -15, 0] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                className="absolute left-1/4 top-0 w-16 h-16 rounded-2xl bg-card/80 backdrop-blur border border-border/50 shadow-xl flex items-center justify-center"
              >
              ...
              <motion.div
                ...
                className="absolute left-1/2 -translate-x-1/2 top-8 w-20 h-20 rounded-2xl bg-card/80 backdrop-blur border border-border/50 shadow-xl flex items-center justify-center"
              >
              ...
              <motion.div
                ...
                className="absolute right-1/4 top-2 w-16 h-16 rounded-2xl bg-card/80 backdrop-blur border border-border/50 shadow-xl flex items-center justify-center"
              >
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center max-w-4xl mx-auto mb-20">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 tracking-tight">
                Why Traditional Systems Are{' '}
                <span className="text-destructive">Holding You Back</span>
              </h2>
              <p className="text-xl text-muted-foreground leading-relaxed">
                Disconnected systems, paper prescriptions, stock shortages, and manual billing slow pharmacies down. Patients expect speed, transparency, and digital access.
              </p>
            </AnimatedSection>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {[
                ...
                { from: "Manual inventory", to: "Automated tracking", icon: Package },
                ...
                <AnimatedSection key={index}>
                  <Card className="p-8 text-center border-border/30 bg-card/40 backdrop-blur-xl h-full hover:border-primary/20 transition-all duration-500">
                    ...
                    <p className="text-muted-foreground line-through mb-3">{item.from}</p>
                    <p className="font-semibold text-foreground text-lg">{item.to}</p>
                  </Card>
                </AnimatedSection>
              ))}
            </div>
