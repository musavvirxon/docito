        ...
        <Card className="border border-border shadow-sm">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Button onClick={(e) => { e.stopPropagation(); onRequestVerify(); }}>
...
const AdminDashboard = () => {
  ...
  const lockMessage = "This section is locked until your organization is verified.";
                  ...
                  {messages.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {messages.map((msg: any) => (
                        <div key={msg.id} className="flex items-start gap-3 p-3 bg-muted/40 rounded-xl border border-border">
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => guarded(() => setInviteProviderOpen(true))}>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex items-center gap-4 flex-wrap justify-end">
                          ...
                          <Button variant="outline" size="sm" onClick={() => guarded(() => toast.info("Edit provider (coming soon)"))}>
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => guarded(() => setAddLocationOpen(true))}>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex gap-2">
                          <Button variant="outline" size="sm" onClick={() => guarded(() => toast.info("Edit location (coming soon)"))}>
                            Edit
                          </Button>
                          <Button variant="outline" size="sm" onClick={() => guarded(() => toast.info("Photos (coming soon)"))}>
                            Upload Photos
                          </Button>
                        </div>
                      </div>
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => guarded(() => setAddServiceOpen(true))}>Add New Service</Button>
            </div>
            ...
            {services.length === 0 ? (
              <Card className="mt-6 rounded-xl">
                <CardContent className="p-12 text-center">
                  ...
                  <Button onClick={() => guarded(() => setAddServiceOpen(true))}>Add First Service</Button>
                </CardContent>
              </Card>
            ) : (
              <div className="grid gap-4 mt-6">
                  ...
                  <Card key={service.id} className="rounded-xl">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex items-center gap-2">
                          <Button variant="outline" size="sm" onClick={() => guarded(() => toast.info("Edit service (coming soon)"))}>
                            Edit
                          </Button>
                        </div>
                      </div>
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => guarded(() => setInviteStaffOpen(true))}>
                <Mail className="h-4 w-4 mr-2" />
                Invite Staff Member
              </Button>
            </div>

            {practice && <div className="mt-6"><PendingInvitationsSection practiceId={practice.id} /></div>}
                    ...
                    {staff.map((member: any) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button variant="outline" size="sm" onClick={() => guarded(() => toast.info("Edit staff (coming soon)"))}>
                            Edit
                          </Button>
                        </div>
                      </div>
          ...
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                ...
                <Button variant="outline" onClick={() => guarded(() => toast.info("Export (coming soon)"))}>Export</Button>
              </div>
            </div>
                ...
                <CardContent className="p-0">
                  ...
                  {patients.map((patient: any) => (
                    <div
                      ...
                      onClick={() => guarded(() => toast.info("Patient details (coming soon)"))}
                    >
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => guarded(() => toast.info("Generate report (coming soon)"))}>Generate Report</Button>
            </div>
                  ...
                  {payments.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {payments.slice(0, 3).map((payment: any) => (
                        <div key={payment.id} className="flex items-center justify-between p-3 bg-muted/40 rounded-xl border border-border">
                          <div>
        ...
        return (
          <SectionWrapper locked={!isVerified}>
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => guarded(() => toast.info("Date range (coming soon)"))}>
                  Last 30 Days
                </Button>
                <Button variant="outline" onClick={() => guarded(() => toast.info("Export report (coming soon)"))}>
                  Export Report
                </Button>
              </div>
            </div>
      ...
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex h-16 items-center justify-between px-4 sm:px-6">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => guarded(() => toast.info("Profile preview (coming soon)"))}
          ...
          <main className="flex-1 p-4 sm:p-6 space-y-6">
            {/* Verification banner (always visible, actionable) */}
        ...
        {/* Modals (actions are guarded; but keep mounted) */}
