...
const HealthcareMessageThread: React.FC<HealthcareMessageThreadProps> = memo(
  ({ conversation, messages, loading, onSendMessage, isLocked = false }) => {
    const { user } = useAuth();
    ...
    const handleFileUpload = useCallback(async (file: File) => {
      // NOTE: Your current thread props don't include an upload handler.
      // If your hook provides uploadAttachment(), pass it into this component and call it here.
