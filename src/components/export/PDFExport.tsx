    ...
    const printContent = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <div>Prepared by ${practiceName}</div>
            <div style="margin-top:4px;font-size:10px;color:#999;">Generated by Docito · <a href="https://docito.app" style="color:#999;">docito.app</a></div>
          </div>
        </body>
      </html>
    `;
