    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-visible pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          ...
          <p
            ref={subtitleRef}
            className="text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto font-light leading-relaxed"
            style={{ opacity: 0 }}
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-3 gap-8 pt-8 max-w-lg mx-auto"
          >
            {[
