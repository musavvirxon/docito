...
const metrics = [
  { id: 'patients', value: 1247, suffix: '', icon: Users, color: 'text-blue-500' },
  { id: 'today', value: 24, suffix: '', icon: Calendar, color: 'text-emerald-500' },
  { id: 'rating', value: 4.9, suffix: '★', icon: Star, color: 'text-amber-500', decimals: 1 },
  { id: 'uptime', value: 99.9, suffix: '%', icon: Activity, color: 'text-purple-500', decimals: 1 },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="lg:col-span-2">
            ...
            >
              {t('home:metrics.badge', 'Live Dashboard')}
            </motion.span>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-3xl sm:text-4xl font-light text-foreground mb-8"
            >
              {t('home:metrics.title', 'Real-time Performance')}
            </motion.h2>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="p-6 bg-background/50 backdrop-blur-xl border border-border/50 rounded-2xl">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-5 h-5 text-emerald-500" />
                  <span className="text-sm font-medium text-foreground">
                    {t('home:metrics.growth', 'Weekly Growth')}
                  </span>
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-border/50 flex items-center justify-between text-sm">
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span>{t('home:metrics.lastUpdated', 'Updated just now')}</span>
                </div>
                <motion.div
